...
public class Event {
    ...
    /**
     * current_capacity stocke les places RESTANTES (disponibles).
     * getAvailableSeats() retourne donc directement currentCapacity.
     */
    public int getAvailableSeats() { return currentCapacity; }
    public boolean isAvailable() { return STATUS_A_VENIR.equals(status) && currentCapacity > 0; }
