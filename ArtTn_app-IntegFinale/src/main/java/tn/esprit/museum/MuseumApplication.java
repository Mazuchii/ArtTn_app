...
public class MuseumApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        // ── Initialiser le gestionnaire de localisation (restaure la langue sauvegardée) ──
        ...
        // Appliquer l'orientation RTL si nécessaire
        lm.applyOrientation(root);

        primaryStage.setTitle(lm.getString("app.title") + " - " + lm.getString("login.title"));
