        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    boolean passwordMatches = PasswordHasher.verifyPasswordBCrypt(password, storedHashedPassword);
                    boolean legacyPlainTextMatch = !PasswordHasher.isBCryptHash(storedHashedPassword)
