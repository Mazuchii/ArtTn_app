...
public class EmailUtil {
    ...
    private static final String PASSWORD  = "deld dcxh tcnc hdof";

    public static void sendReservationStatusEmail(String toEmail, String clientName,
                                                   String eventTitle, String status, String comment) {
    ...
    private static String buildEmailContent(String clientName, String eventTitle,
