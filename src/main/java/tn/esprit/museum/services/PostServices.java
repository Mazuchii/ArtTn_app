...
import tn.esprit.museum.interfaces.IPostServices;
...
public class PostServices implements IPostServices<Posts> {
    ...
    public void addpost(Posts p) {
        ...
        try {
            PreparedStatement pst = DatabaseConnection.getInstance().getCnx().prepareStatement(requete);
    ...
    public List<Posts> getPostData() {
        ...
        try {
            Statement st = DatabaseConnection.getInstance().getCnx().createStatement();
    ...
    public void addView(int postId, int userId) {
        ...
        try {
            ...
            PreparedStatement pst2 = DatabaseConnection.getInstance().getCnx().prepareStatement(updateSql);
    ...
    public void addReaction(int postId, int userId, String type) {
        ...
        if (existingReaction != null && existingReaction.equals(type)) {
            ...
            try {
                PreparedStatement pst = DatabaseConnection.getInstance().getCnx().prepareStatement(deleteSql);
                pst.setInt(1, postId);
                pst.setInt(2, userId);
                pst.executeUpdate();
        ...
        try {
            PreparedStatement pst = DatabaseConnection.getInstance().getCnx().prepareStatement(insertSql);
            pst.setInt(1, postId);
            pst.setInt(2, userId);
