...
public class DashboardController {
    ...
    private void updateActiveButton(Button activeButton) {
        ...
        btnDashboard.getStyleClass().removeAll("menu-button-active");
        btnUtilisateurs.getStyleClass().removeAll("menu-button-active");
        btnProduits.getStyleClass().removeAll("menu-button-active");
        btnEvenements.getStyleClass().removeAll("menu-button-active");
        btnSponsors.getStyleClass().removeAll("menu-button-active");
        btnEmployes.getStyleClass().removeAll("menu-button-active");
        btnForum.getStyleClass().removeAll("menu-button-active");
