...
public class ForumEditPostController {
    ...
    private tn.esprit.museum.controllers.ForumPostDetailController parentController;
    ...
    public void setPost(Posts post, tn.esprit.museum.controllers.ForumPostDetailController parent) {
